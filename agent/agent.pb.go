...
const (
	...
	Message_TLSEvent            Message_Type = 7
)
...
func (x *TLSEvent) GetAuthority() []byte {
	if x != nil {
		return x.Authority
	}
	return nil
...
func (x *Message) GetCredentials() *TLSEvent {
	if x, ok := x.GetEvent().(*Message_Credentials); ok {
...
type Message_Credentials struct {
	Credentials *TLSEvent `protobuf:"bytes,12,opt,name=credentials,proto3,oneof"`
}
...
func (*Message_Credentials) isMessage_Event() {}
...
var file_agent_proto_rawDesc = []byte{
	...
	0x0a, 0x04, 0x47, 0x6f, 0x6e, 0x65, 0x10, 0x03, 0x22, 0x7e, 0x0a, 0x08, 0x54, 0x4c, 0x53, 0x45,
	...
	0x72, 0x70, 0x72, 0x69, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72,
	0x69, 0x74, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x41, 0x75, 0x74, 0x68, 0x6f,
	0x72, 0x69, 0x74, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x4b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x03, 0x4b, 0x65, 0x79, 0x12, 0x20, 0x0a, 0x0b, 0x43, 0x65, 0x72, 0x74, 0x69, 0x66,
	0x69, 0x63, 0x61, 0x74, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x43, 0x65, 0x72,
	0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x65, 0x22, 0x4f, 0x0a, 0x0b, 0x57, 0x41, 0x4c, 0x50,
	...
	0x28, 0x05, 0x52, 0x05, 0x50, 0x61, 0x74, 0x63, 0x68, 0x22, 0x8c, 0x05, 0x0a, 0x07, 0x4d, 0x65,
	...
	0x6d, 0x62, 0x65, 0x72, 0x73, 0x68, 0x69, 0x70, 0x12, 0x33, 0x0a, 0x0b, 0x63, 0x72, 0x65, 0x64,
	0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e,
	0x61, 0x67, 0x65, 0x6e, 0x74, 0x2e, 0x54, 0x4c, 0x53, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x48, 0x00,
	0x52, 0x0b, 0x63, 0x72, 0x65, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x61, 0x6c, 0x73, 0x22, 0x25, 0x0a,
	...
	0x65, 0x64, 0x10, 0x01, 0x22, 0x88, 0x01, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0d, 0x0a,
	...
	0x05, 0x12, 0x0c, 0x0a, 0x08, 0x54, 0x4c, 0x53, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x10, 0x07, 0x42,
	...
	0x22, 0x00, 0x30, 0x01, 0x32, 0xe3, 0x02, 0x0a, 0x06, 0x51, 0x75, 0x6f, 0x72, 0x75, 0x6d, 0x12,
...
var file_agent_proto_depIdxs = []int32{
	...
	11, // 8: agent.Message.credentials:type_name -> agent.TLSEvent
	13, // 9: agent.WAL.messages:type_name -> agent.Message
	3,  // 10: agent.DeployCommand.command:type_name -> agent.DeployCommand.Command
	8,  // 11: agent.DeployCommand.archive:type_name -> agent.Archive
	15, // 12: agent.DeployCommand.options:type_name -> agent.DeployOptions
	4,  // 13: agent.Deploy.stage:type_name -> agent.Deploy.Stage
	8,  // 14: agent.Deploy.archive:type_name -> agent.Archive
	15, // 15: agent.Deploy.options:type_name -> agent.DeployOptions
	8,  // 16: agent.DeployCommandRequest.archive:type_name -> agent.Archive
	15, // 17: agent.DeployCommandRequest.options:type_name -> agent.DeployOptions
	10, // 18: agent.DeployCommandRequest.peers:type_name -> agent.Peer
	21, // 19: agent.UploadChunk.metadata:type_name -> agent.UploadMetadata
	8,  // 20: agent.UploadResponse.archive:type_name -> agent.Archive
	5,  // 21: agent.InfoResponse.mode:type_name -> agent.InfoResponse.Mode
	16, // 22: agent.InfoResponse.deploying:type_name -> agent.DeployCommand
	16, // 23: agent.InfoResponse.deployed:type_name -> agent.DeployCommand
	10, // 24: agent.InfoResponse.leader:type_name -> agent.Peer
	10, // 25: agent.InfoResponse.quorum:type_name -> agent.Peer
	10, // 26: agent.ConnectResponse.quorum:type_name -> agent.Peer
	10, // 27: agent.StatusResponse.peer:type_name -> agent.Peer
	17, // 28: agent.StatusResponse.deployments:type_name -> agent.Deploy
	8,  // 29: agent.DeployRequest.archive:type_name -> agent.Archive
	...
	22, // 43: agent.Quorum.Upload:input_type -> agent.UploadChunk
	24, // 44: agent.Quorum.Watch:input_type -> agent.WatchRequest
	40, // 45: agent.Quorum.Dispatch:input_type -> agent.DispatchRequest
	18, // 46: agent.Quorum.Deploy:input_type -> agent.DeployCommandRequest
	26, // 47: agent.Quorum.Info:input_type -> agent.InfoRequest
	36, // 48: agent.Quorum.Cancel:input_type -> agent.CancelRequest
	28, // 49: agent.Agent.Connect:input_type -> agent.ConnectRequest
	30, // 50: agent.Agent.Info:input_type -> agent.StatusRequest
	32, // 51: agent.Agent.Deploy:input_type -> agent.DeployRequest
	36, // 52: agent.Agent.Cancel:input_type -> agent.CancelRequest
	34, // 53: agent.Agent.Shutdown:input_type -> agent.ShutdownRequest
	38, // 54: agent.Agent.Logs:input_type -> agent.LogRequest
	40, // 55: agent.Observer.Dispatch:input_type -> agent.DispatchRequest
	41, // 56: agent.Bootstrap.Archive:input_type -> agent.ArchiveRequest
	43, // 57: agent.Cluster.Watch:input_type -> agent.ClusterWatchRequest
	23, // 58: agent.Deployments.Upload:output_type -> agent.UploadResponse
	19, // 59: agent.Deployments.Deploy:output_type -> agent.DeployCommandResult
	37, // 60: agent.Deployments.Cancel:output_type -> agent.CancelResponse
	39, // 61: agent.Deployments.Logs:output_type -> agent.LogResponse
	13, // 62: agent.Deployments.Watch:output_type -> agent.Message
	23, // 63: agent.Quorum.Upload:output_type -> agent.UploadResponse
	13, // 64: agent.Quorum.Watch:output_type -> agent.Message
	25, // 65: agent.Quorum.Dispatch:output_type -> agent.DispatchResponse
	19, // 66: agent.Quorum.Deploy:output_type -> agent.DeployCommandResult
	27, // 67: agent.Quorum.Info:output_type -> agent.InfoResponse
	37, // 68: agent.Quorum.Cancel:output_type -> agent.CancelResponse
	29, // 69: agent.Agent.Connect:output_type -> agent.ConnectResponse
	31, // 70: agent.Agent.Info:output_type -> agent.StatusResponse
	33, // 71: agent.Agent.Deploy:output_type -> agent.DeployResponse
	37, // 72: agent.Agent.Cancel:output_type -> agent.CancelResponse
	35, // 73: agent.Agent.Shutdown:output_type -> agent.ShutdownResponse
	39, // 74: agent.Agent.Logs:output_type -> agent.LogResponse
	25, // 75: agent.Observer.Dispatch:output_type -> agent.DispatchResponse
	42, // 76: agent.Bootstrap.Archive:output_type -> agent.ArchiveResponse
	44, // 77: agent.Cluster.Watch:output_type -> agent.ClusterWatchEvents
