...
func (InfoResponse_Mode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{17, 0} }
...
func (*InfoRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }

type InfoResponse struct {
	Mode      InfoResponse_Mode `protobuf:"varint,1,opt,name=mode,enum=agent.InfoResponse_Mode" json:"mode,omitempty"`
	Deploying *DeployCommand    `protobuf:"bytes,2,opt,name=deploying" json:"deploying,omitempty"`
	Deployed  *DeployCommand    `protobuf:"bytes,3,opt,name=deployed" json:"deployed,omitempty"`
}
...
func (*ConnectRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func (*ConnectResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{19} }
...
func (*DeployRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{22} }
...
func (*DeployResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }
...
func (*ShutdownRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{24} }
...
func (*ShutdownResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }
...
func (*CancelRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }
...
func (*CancelResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{27} }
...
func (*LogRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{28} }
...
func (*LogResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{29} }
...
func (*DispatchRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{30} }
...
func (c *quorumClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := grpc.Invoke(ctx, "/agent.Quorum/Info", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *quorumClient) Cancel(ctx context.Context, in *CancelRequest, opts ...grpc.CallOption) (*CancelResponse, error) {
	...
	err := grpc.Invoke(ctx, "/agent.Quorum/Cancel", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) Logs(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (Agent_LogsClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Agent_serviceDesc.Streams[0], c.cc, "/agent.Agent/Logs", opts...)
	if err != nil {
		return nil, err
	}
