...
const (
	...
	EnvAgentCachedTLSCertificateMinimum  = "BEARDED_WOOKIE_AGENT_CACHED_TLS_CERTIFICATE_MINIMUM"       // minimum duration in milliseconds that a certificate needs to be valid for to be acceptable for use.
)
