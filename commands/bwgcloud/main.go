...
// ./bin/bwgcloud dns --hzone=Z1QRT9PG2F57XP --region="us-east-1" --cluster=127.0.0.1:2001 --cluster=127.0.0.2:2001 --agent-config=".bwagent1/agent.config"
func main() {
	var (
		err             error
		exitCode        int
	...
	app := kingpin.New("bwgcloud", "bearded wookie utility programs for google cloud").Version(commands.Version)
